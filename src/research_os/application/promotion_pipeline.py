...
from research_os.data.records import CandidateRecord, PromotionRunRecord
...
from research_os.research.finding_proposal import FindingProposalAdmissionOutcome
