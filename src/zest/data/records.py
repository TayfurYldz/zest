...
from zest.safe_data import SecretMaterialError, reject_secret_keys as reject_secret_structure
...
# Mirrors zest.research.orchestration.TERMINAL_ORCHESTRATION_STATES.
...
class RuntimeInstanceRecord:
    """Durable identity of one zestd process. Not research authority."""
