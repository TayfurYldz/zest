...
from zest.data.errors import DatabaseUnavailableError, PersistenceInputError
...
TEST_DATABASE_URL_ENV = "ZEST_TEST_DATABASE_URL"
...
def validate_test_database_url(
    ...
    *,
    ...
    Isolation is by explicit ZEST_TEST_DATABASE_URL only. Unrelated
