...
from zest.research.model_runtime import ModelRuntimeIdentity, api_runtime_identity

from zest.integrations.models.json_schemas import (
    decode_transport_output_for_request,
    schema_for_request,
)
from zest.integrations.models.secrets import redact_secret
...
class JsonSchemaModelAdapter:
    ...
    def complete(self, request: ModelCallRequest) -> ModelCallResult:
        ...
        structured = decode_transport_output_for_request(
            request, parse_structured_object(invocation.text, secret=self._secret)
        )
