...
from zest.data.postgres.tables import hunter_family, metadata
...
TRUNCATE_GUARD = "ZEST_ALLOW_SPINE_TRUNCATE"
...
def truncate_spine(
    ...
    *,
    ...
    Does not check ZEST_ALLOW_SPINE_TRUNCATE. The VDS fixture must
    ...
    records so running daemon processes (e.g. systemd zestd) do not
