...
from zest.benchmark.evaluate import ScenarioRunResult, evaluate_scenario
from zest.benchmark.failures import FailureClass, PROVIDER_FAILURE_CLASSES
from zest.benchmark.holdout import HoldoutLoad
from zest.benchmark.identity import (
    BenchmarkExperimentConfig,
    ModelConfigurationIdentity,
)
from zest.benchmark.scenarios import BenchmarkScenario
from zest.benchmark.source_provenance import SourceProvenance
...
def compare_experiments(left: ExperimentReport, right: ExperimentReport) -> PairedComparison:
    if left.git_commit != right.git_commit:
        return PairedComparison(
            comparable=False,
            reason="Zest commit differs; results are not directly comparable",
