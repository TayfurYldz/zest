...
from zest.benchmark.baselines import BASELINE_NAMES, create_baseline
...
from zest.benchmark.evaluate import evaluate_suite, format_scorecard
...
from zest.benchmark.failures import PROVIDER_FAILURE_CLASSES
from zest.benchmark.holdout import HOLDOUT_PATH_ENV, load_sealed_holdout, resolve_holdout_path
...
from zest.research.context import ObservationSource
...
from zest.research.output_contracts import STRICT_TRANSPORT_SCHEMA_VERSION
...
def packaged_scenario_directory_context():
    return as_file(files("zest.resources").joinpath("benchmarks", "research", "scenarios"))
...
def run_cli(
    ...
    *,
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run the Zest provider-neutral research benchmark. "
