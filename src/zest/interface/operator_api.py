"""Local Operator API for zestd. Not a public internet service.
...
def _runtime_health_ids(runtime: ZestdRuntime) -> dict[str, object]:
...
class OperatorApiHandler(BaseHTTPRequestHandler):
    server_version = "ZestdOperator/1.0"

    @property
    def runtime(self) -> ZestdRuntime:
