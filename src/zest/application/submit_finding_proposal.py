...
from zest.application.impact.proof_resolver import (
...
from zest.data.records import AuditEventRecord, FindingProposalRecord
from zest.data.uniqueness import UQ_FINDING_PROPOSAL_CANDIDATE, is_uniqueness_conflict
from zest.data.unit_of_work import UnitOfWork
from zest.research.candidate import (
    DIAGNOSTIC_CANDIDATE_CLASSIFICATION,
    CandidateState,
)
from zest.research.impact.capability_map import validate_chain_impact_scope
